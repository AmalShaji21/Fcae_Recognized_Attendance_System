...
Amal_image = face_recognition.load_image_file("facesid/Amal.jpg")
Amal_encoding = face_recognition.face_encodings(Amal_image)[0]
known_face_encodings = [Amal_encoding]
